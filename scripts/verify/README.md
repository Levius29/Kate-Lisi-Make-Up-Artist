...
| `audit-dom.mjs` | Duplicate element ids, missing focus rings, an undeclared `color-scheme`, and developer jargon leaking into user-facing text. |
...
Set `ROUTES` (comma-separated hash routes) and `SHOT_DIR` to narrow or redirect a run:
